...
export const Settings = (props: SettingsType) => {
    ...
    return (
        <div className={s.settings}>
            <div>maxValue:<input value={props.changeValueSettings.maxValue} onChange={dispatchMaxValue} type={'number'}/></div>
            <div>start value:<input value={props.changeValueSettings.startValue} onChange={dispatchStartValue} type={'number'}/>
            </div>
        </div>
    );
};
